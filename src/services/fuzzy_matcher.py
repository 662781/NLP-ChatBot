...
class FuzzyMatcher:
    ...
    def __init__(self) -> None:
        self.qa_kg: dict = self.create_question_dict()
        self.qa_kg: dict = {
            ...
            "What rudiments studied Gandhi ?": "Gandhi studied the rudiments of arithmetic, history, geography, and languages during his early education.",
            "What High School did Gandhi join?": "Gandhi joined high school in Rajkot, where he continued his education and further developed his intellectual and leadership abilities.",
            ...
            "What informed Gandhi's ways?": "Gandhi's ways were informed by his deep study of religious and philosophical texts, including Hindu scriptures, the Bible, and the teachings of various spiritual leaders and philosophers.",
    ...
    def find_answer(self, user_question: str):
        """ Finds the correct answer by comparing the user's question to the sentences from the q&a dictionary and then returning the assiociated answer."""
        answer = None
        max_similarity = 80

        for question in self.qa_kg:
            similarity = fuzz.ratio(user_question, question)
            if similarity > max_similarity:
                max_similarity = similarity
                answer = self.qa_kg[question]
        return answer
